...
const THEMES = {
  "Movies": [
    ...
    "GREASE","VERTIGO","CHINATOWN","PLATOON","AMADEUS","TOOTSIE","BAMBI","DUMBO",
    "ALADDIN","FANTASIA","PINOCCHIO","CINDERELLA","GHOSTBUSTERS","BEETLEJUICE",
    "CLUELESS","ROBOCOP","PREDATOR","TERMINATOR","RAMBO","MOANA","FROZEN","COCO",
    "SHREK","SPEED","MEMENTO","INTERSTELLAR","ARRIVAL","PARASITE","GRAVITY",
    "WHIPLASH","ZODIAC","JUNO","CORALINE","TANGLED","BRAVE","RATATOUILLE","MULAN",
    "TENET","DUNKIRK","JOKER","LOGAN","ZOOTOPIA","ENCANTO","OPPENHEIMER","BARBIE",
    "NEMO","SOLO","CLIFFHANGER","AMELIE","ANCHORMAN","AIRPLANE","ANNIHILATION",
    "ANASTASIA","AQUAMAN","BABEL","BLADE","BORAT","BOYHOOD","BRIDESMAIDS",
    "CASINO","CARRIE","CANDYMAN","CONTACT","COBRA","CONJURING","CRASH","CREED",
    "CHRISTINE","COMMANDO","CONSTANTINE","DEADPOOL","DIVERGENT","DREDD","DRIVE",
    "DUNE","ELEMENTAL","ELYSIUM","EQUILIBRIUM","ERAGON","EVITA","EXCALIBUR",
    "EXTRACTION","FARGO","FLASHDANCE","FLATLINERS","FLIGHT","FOOTLOOSE",
    "FOXCATCHER","FURY","GANDHI","GATTACA","GHOST","GOLDENEYE","GREMLINS",
    "GRINDHOUSE","HAIRSPRAY","HALLOWEEN","HANCOCK","HANNA","HEREDITARY",
    "HERCULES","HITMAN","HOLES","HOOK","HUGO","HULK","IDIOCRACY","INFERNO",
    "INSIDIOUS","INSOMNIA","JUMANJI","KONG","LABYRINTH","LUCA","LUCY","LIFE",
    "LIMITLESS","LINCOLN","LION","LOOPER","MACHETE","MADAGASCAR","MAGNOLIA",
    "MALEFICENT","MASK","MATILDA","MAVERICK","MEGAMIND","METROPOLIS","MIDWAY",
    "MIDSOMMAR","MISERY","MOONLIGHT","NAPOLEON","NEBRASKA","NETWORK","NOAH",
    "NOPE","NOSFERATU","NOTORIOUS","OBLIVION","OLDBOY","ONWARD","ORPHAN",
    "PADDINGTON","PASSENGERS","PHILADELPHIA","POLTERGEIST","POMPEII","PRECIOUS",
    "PRISONERS","PROMETHEUS","RANGO","REBECCA","ROMA","ROOM","RUSHMORE",
    "SABRINA","SAHARA","SALT","SCREAM","SELMA","SERENITY","SICARIO","SIGNS",
    "SILENCE","SINISTER","SKYFALL","SMILE","SNATCH","SOUL","SPECTRE","SPLIT",
    "SPOTLIGHT","STARDUST","STOKER","STRIPES","SULLY","SUPERBAD","SUNSHINE",
    "SUSPIRIA","SWORDFISH","TAKEN","TARZAN","THOR","TRAINSPOTTING","TRON",
    "TROY","TURBO","TWISTER","UNFORGIVEN","UNBREAKABLE","UNDERWORLD","UPGRADE",
    "VALKYRIE","VENOM","VOLCANO","WANTED","WARCRAFT","WARRIOR","WATCHMEN",
    "WICKED","WILLOW","WISH","WONDER","WOLVERINE",
  ],
  "Countries": [
